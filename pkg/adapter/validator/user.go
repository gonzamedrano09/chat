...
func (uv *UserValidator) ValidateUsernameLength(user *entity.User, errs map[string][]string) {
...
func (uv *UserValidator) ValidateUsernameExistence(user *entity.User, errs map[string][]string) {
...
func (uv *UserValidator) ValidatePasswordLength(user *entity.User, errs map[string][]string) {
	if len(user.Password) < 8 {
		errs["password"] = append(errs["password"], "password length must be more than 8")
	}
}

func (uv *UserValidator) ValidateFirstNameLength(user *entity.User, errs map[string][]string) {
...
func (uv *UserValidator) ValidateLastNameLength(user *entity.User, errs map[string][]string) {
...
func (uv *UserValidator) ValidateValidGender(user *entity.User, errs map[string][]string) {
